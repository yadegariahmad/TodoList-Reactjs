          ...
          <div className="overlay-container">
            <div className="overlay">
              <div className="overlay-panel overlay-left">
                ...
                <button type="button" className="ghost" onClick={() => { this.setState({ mode: 'signIn' }); }}>Sign In</button>
              </div>
              <div className="overlay-panel overlay-right">
                <h1>Hello, Friend!</h1>
                <p>Enter your personal details and start journey with us</p>
                <button type="button" className="ghost" onClick={() => { this.setState({ mode: 'signUp' }); }}>Sign Up</button>
              </div>
            </div>
          </div>
